...
namespace FetchQuest
{
    ...
    class Camera
    {
        ...
        public static void Move(Vector2 offset)//Moves the camera to follow the player
        {//EDITED BY DAN {
            Position = new Vector2(Player.CharacterSprite.WorldLocation.X - (ViewPortWidth / 2), Player.CharacterSprite.WorldLocation.Y - (ViewPortHeight / 2));
        }//} EDITED BY DAN
